 ...
 * 
 * 
 * CAUTION -- I HAD TO MANUALLY A A DCJLINKLABEL REFERENCE IN HERE.
 *            MAKE SURE IT IS REPLACED IF THIS FILE IS MODIFIED.
 *            LOOK FOR 'AJA' REFERENCES BELOW.
 * 
 * 
 * 
 * 
...
public class ApplyLicenseDialog extends JDialog {
  ...
  // AJA
  //
  public DCJLinkLabel getNeedALicenseLabel() {
  ...
  // AJA
  // 
  private DCJLinkLabel needALicenseLabel = new DCJLinkLabel("Need a license? Click here.", "http://devdaily.com/hide-your-desktop");
